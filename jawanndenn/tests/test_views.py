...
class PollDataGetViewTest(TestCase):
    ...
    def test_poll_exists(self):
        ...
        expected_data = {
            ...
            "votes": [[self.ballot.voter_name, [v.choice for v in self.votes]],],
        }
...
class VotePostViewTest(TestCase):
    ...
    def test_poll_exists(self):
        ...
        self.assertEqual(
            list(
                ballot.votes.order_by("option__position").values_list(
                    "choice", flat=True
                )
            ),
            ["A", "R"],
...
class ServeUsingFindersTest(TestCase):
    @parameterized.expand(
        [
            ...
            (
                "jawanndenn",
                "3rdparty/github-buttons-4.0.1/docs/github-btn.html",
                "sameorigin",
            ),
