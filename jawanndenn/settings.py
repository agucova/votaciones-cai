...
ALLOWED_HOSTS = os.environ.get(
    "JAWANNDENN_ALLOWED_HOSTS", ",".join(["127.0.0.1", "0.0.0.0", "localhost",])
).split(",")
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR, "jawanndenn", "static"),],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
JAWANNDENN_MAX_POLLS = int(
    os.environ.get("JAWANNDENN_MAX_POLLS", str(DEFAULT_MAX_POLLS))
)
